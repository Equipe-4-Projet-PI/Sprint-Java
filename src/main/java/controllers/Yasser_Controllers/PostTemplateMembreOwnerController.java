...
//            post_label_id.getScene().setRoot(root);
    ...
    private Parent loadRootEdit() throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Interfaces/ForumPages/Member/EditPostPageMembre.fxml"));
        EditPostPageMembreController controller = new EditPostPageMembreController();
        loader.setController(controller);
        controller.setData(SF.getbyid(post.getId_forum()),userlogged,post); // Add data to the controller
