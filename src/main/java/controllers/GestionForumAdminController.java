...
public class GestionForumAdminController {
    ...
    void AddForum(ActionEvent event) {
        try {
            Parent root= FXMLLoader.load(getClass().getResource("/ForumPages/Admin/AddForumAdmin.fxml"));
    ...
    void ConfirmDeletion(ActionEvent event)
    {
        try {
            ...
            SF.supprimer(f);
            Parent root= FXMLLoader.load(getClass().getResource("/ForumPages/Admin/GestionForumAdmin.fxml"));
    ...
    private Parent loadRootLayout(ForumEntity f) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/ForumPages/Admin/EditForumAdmin.fxml"));
